...
To ensure the model's efficacy when applied to the Evaluation data set, we first apply a set of transformations to that data set identical to those applied to the Training data set during the development of the TB PLUS model. The TB PLUS model is then applied to yield a set of INDEX / TARGET_WINS pairs.  Since displaying the full set of predicted values would consume a large number of pages, a sample of the first 10 rows of that data set is displayed as an example:
